...
advocate5000 is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running advocate5000 Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start advocate5000 locally by running:
...
Then you can interact with advocate5000 by typing `advocate5000 help`.

    advocate5000> advocate5000 help
    advocate5000 animate me <query> - The same thing as `image me`, except adds [snip]
